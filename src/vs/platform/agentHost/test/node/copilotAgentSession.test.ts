...
import { createNoopGitService, createSessionDataService, createZeroDiffComputeService } from '../common/sessionTestHelpers.js';
...
suite('CopilotAgentSession', () => {
	...
	suite('repoInfo telemetry', () => {
		...
		test('captures begin and end for the root turn only', async () => {
			...
			assert.deepStrictEqual(telemetryService.events
				...
				{ destination: 'enhanced', location: 'begin', telemetryMessageId: 'root-turn', result: 'noChanges' },
				{ destination: 'internal', location: 'begin', telemetryMessageId: 'root-turn', result: 'noChanges' },
				{ destination: 'enhanced', location: 'end', telemetryMessageId: 'root-turn', result: 'noChanges' },
				{ destination: 'internal', location: 'end', telemetryMessageId: 'root-turn', result: 'noChanges' },
			]);
		});
